...
/// Source: https://github.com/aptos-labs/aptos-core/blob/02645456683be12c1b8b8e235453f01d639d8cc1/aptos-move/move-examples/large_packages/sources/large_packages.move
...
module apto_orm::large_packages {
    use std::error;
    use std::signer;
    use std::vector;
